...
# Create motif user
RUN adduser --system --group --disabled-password motif && \
	mkdir -p /wallet /home/motif/.bitmotif && \
	chown -R motif:motif /home/motif/.bitmotif && \
	chown -R motif:motif /wallet

# Contains the blockchain
VOLUME /home/motif/.bitmotif
...
# switch to user motif
USER motif

ENTRYPOINT ["motifd", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=18080", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=18081", "--non-interactive", "--confirm-external-bind"]
